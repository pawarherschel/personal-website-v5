...
Then,
I found #link("https://www.youtube.com/@TheCodingTrain")[The Coding Train]
who inspired me to pursue Java further,
but the biggest inspiration for me was #link("https://www.galaxykate.com/")[Kate Compton]'s talk on #link("https://www.youtube.com/watch?v=WumyfLEa6bU")[Practical Procedural Generation for Everyone].
...
Eventually,
I found #link("https://www.youtube.com/@Acerola_t")[Acerola]'s channel.
...
The most influential YouTube channel for me was #link("https://www.youtube.com/@NoBoilerplate")[No Boilerplate].

=== Rust Era

After getting hyped up on Rust,
I learned it
by doing #link("https://github.com/rust-lang/rustlings")[rustlings].
...
etc.
It's the same concept as #link("https://en.wikipedia.org/wiki/Six_degrees_of_separation")[Six degrees of separation].
...
Acerola uploads #link("https://www.youtube.com/watch?v=O-2viBhLTqI")[What Is A Graphics Programmer?].
I decided to join their discord,
and there's a channel about how to get into graphics programming.

I knew
#link("https://inochi2d.com/")[Inochi2d]'s creator LunaTheFoxgirl knew about Vulkan.
...
#link("https://www.galaxykate.com/")[Kate Compton] inspired me
...
4. Creativity is just connecting things.\
  #quote(
    ...
    block: true,
    attribution: [Steve Jobs (according to #link("https://www.goodreads.com/quotes/1031045-creativity-is-just-connecting-things-when-you-ask-creative-people")[goodreads]; but, I'm not gonna fact check that.)],
  )
...
(like in #link("/posts/fractured-elements-breakdown/")[Fractured Elements Breakdown])
...
#link("/posts/hyperv-shenanigans/")[Hyper-V shenanigans with `nixos-generators`].
...
#quote[Art cannot truely be an escape]

And yet,
expressing gives closure.

#quote[If you're going to give someone flowers, you should probably do it before they wither and die]
...
#bluesky-embed(
  "did:plc:qvzn322kmcvd7xtnips5xaun",
  "3lp5in4mrlk2g",
  "bafyreig5tqvau4b4thkodvhvmjan33hwtm6zfp3u7lssmfwpyskcqvq5zm",
  "John Scalzi",
  "@scalzi.com",
  "May 14, 2025 at 10:42 PM",
)[
  I think about this every time I make music.
  #linebreak()
  #linebreak()
  #link(
    "https://bsky.app/profile/did:plc:qvzn322kmcvd7xtnips5xaun/post/3lp5in4mrlk2g?ref_src=embed",
  )[[image or embed]]
]
...
#link("https://youtu.be/5GcPA3C0QeI")[Terraria Calamity Mod Music - "Roar of The Jungle Dragon" - Theme of Jungle Dragon, Yharon (Phase 2) by DM DOKURO],
...
As one of the #link("https://anilist.co/review/24028")[reviews] put it,
#quote[What it means to be human, as taught by an elf.].
...
Watch: #link("https://www.youtube.com/watch?v=SsclZHp0orE")[Dungeon Meshi - Spelunking On the Spectrum by Superdude]
...
See: #link("https://www.reddit.com/r/DungeonMeshi/comments/1d4yc54/i_have_anorexia_and_when_i_cant_force_myself_to/")[I have anorexia and when I can't force myself to put food in my mouth, I imagine Senshi encouraging me to try, and it works in r/DungeonMeshi]
\
See: #link("https://www.reddit.com/r/DungeonMeshi/comments/1d2zcyq/has_the_show_changed_how_you_view_meals_and_food/")[Has the show changed how you view meals and food? in r/DungeonMeshi]
...
== Website Banner
Low Poly Grid by #link("https://haikei.app/")[haikei]

== Image Hosting
#link("https://developers.cloudflare.com/r2/")[Cloudflare R2]
